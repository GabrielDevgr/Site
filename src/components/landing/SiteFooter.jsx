        ...
        {[
          ...
          const inner = (
            <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.03] px-5 py-4 hover:border-gold/40 transition">
              <span className="grid place-items-center h-10 w-10 shrink-0 rounded-full bg-gold/10 ring-1 ring-gold/40 text-gold">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 py-12 grid gap-10 sm:grid-cols-3">
          ...
          <div>
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-fuchsia-500 to-violet-600 hover:brightness-110 text-white font-bold px-5 h-12 text-sm transition shadow-[0_0_30px_-6px_rgba(192,38,211,0.6)]"
            >
